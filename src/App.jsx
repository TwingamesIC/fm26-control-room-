...
function App() {
  ...
  // 6. TRADUTTORE GRAFICO PER LA CHAT (Rimuove gli asterischi e colora i testi)
  ...
  // 8. AZIONI UTENTE (Blindate con Arrow Functions)
  ...
  // 10. FUNZIONI MULTIMEDIALI AVANZATE (Arrow Functions)
